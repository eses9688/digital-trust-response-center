...
export const stage2: Stage = {
  ...
  evidences: [
    ...
    },
    {
      ...
      title: "링크 도메인",
      type: "url",
      content: "http://kb-star.net/verify",
      isKey: true,
    ...
    },
    {
      ...
      title: "메일 본문 톤",
      type: "text",
      content: "'24시간 내', '영구 삭제' — 시간 압박으로 즉각 클릭을 유도하는 전형적 피싱 수법",
      isKey: false,
    },
  ],
  ...
  choices: [
    {
      id: "ch-report",
      text: "피싱 메일로 신고하고 사용자에게 링크 클릭 금지 안내",
      isBest: true,
      hint: "",
    },
    {
      ...
      text: "스팸 처리만 함",
      isBest: false,
      hint: "스팸 차단도 맞지만, 같은 수법에 당하지 않도록 사용자 안내가 필요해요.",
    },
    {
      id: "ch-normal",
      text: "은행 공식 메일로 판단",
      isBest: false,
      hint: "발신 도메인을 다시 확인해 보세요. 공식 도메인과 미묘하게 달라요.",
    },
  ],

  learning: {
    realCase:
      "금융기관 사칭 피싱 메일은 공식과 거의 똑같은 디자인에, 도메인만 미묘하게 다릅니다(kbstar.com vs kb-star.net). 시간 압박 문구로 판단을 흐립니다.",
    prevention:
      "1) 발신 도메인을 공식 사이트와 글자 단위로 비교  2) 메일 속 링크 대신 공식 앱·홈페이지로 직접 접속  3) '긴급', '정지', '삭제' 같은 압박 문구를 경계",
