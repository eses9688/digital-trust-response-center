...
export const stage3: Stage = {
  ...
  evidences: [
    ...
    },
    {
      ...
      title: "대화 패턴",
      type: "text",
      content: "'급하게', '바로 줄게', '카드가 안 돼서' — 검증할 시간을 주지 않고 송금을 압박하는 메신저 피싱의 전형.",
      isKey: false,
    },
  ],
  ...
  choices: [
    {
      id: "ch-report",
      text: "송금 전에 자녀에게 직접 전화로 본인 확인하도록 안내하고 사칭 신고",
      isBest: true,
      hint: "",
    },
    {
      ...
      text: "수상하니 일단 차단",
      isBest: false,
      hint: "차단도 필요하지만, 진짜 자녀가 위급할 수도 있으니 '직접 전화로 본인 확인'을 먼저 안내하는 게 핵심이에요.",
    },
    {
      id: "ch-normal",
      text: "자녀이니 송금하도록 안내",
      isBest: false,
      hint: "번호가 평소와 다르고 계좌 명의도 본인이 아니에요. 송금 전 본인 확인이 필요해요.",
    },
  ],

  learning: {
    realCase:
      "메신저로 자녀를 사칭해 '폰 고장'을 핑계로 부모에게 송금을 요구하는 수법입니다. 임시폰·낯선 번호로 접근하며, 검증할 틈을 주지 않으려 급박함을 강조합니다.",
    prevention:
      "1) 송금 전 반드시 알고 있던 번호로 직접 전화해 본인 확인  2) 계좌 명의가 자녀 본인과 일치하는지 확인  3) '급하다'는 압박일수록 한 박자 멈추고 검증",
